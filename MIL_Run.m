...
if (~isfield(preprocess, 'Mvalue')), preprocess.Mvalue = 1; end;%added for mvalue

if (nargin < 1), Report_Error; end;
[header, para, rem] = ParseCmd(classifier, '--');
if (strcmpi(header, 'classify')), 
    p = str2num(char(ParseParameter(para, {'-v'; '-sf'; '-n'; '-if'; '-of'; '-pf'; '-distrib'; '-mval'}, ...
                                          {'1'; '0'; '1'; '0'; '0'; '0'; '0'; '1'})));
