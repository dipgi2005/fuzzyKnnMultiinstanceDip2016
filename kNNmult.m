%Citation knn- Developed(max accuracy seen: 94.4%) 
%Note-here the output is the bag level accuracy.
%NOTE-Fubctions included here are: citer_label, habsf(Hausdorff Distance).
function [test_bl, test_il, test_bp, test_ip] = kNNmult(para, train_bags, test_bags)
global preprocess;
...
% yp=input('Enter 1-Hanshroff Dist & 2-Min Dist & 3-Surjective Dist: ');
yp=4;
